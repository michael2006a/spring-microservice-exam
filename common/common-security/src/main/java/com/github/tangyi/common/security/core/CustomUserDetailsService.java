...
public interface CustomUserDetailsService {
   ...
   */
  UserDetails loadUserByIdentifierAndTenantCode(String username, String tenantCode)
   ...
   */
  UserDetails loadUserBySocialAndTenantCode(String social, String tenantCode, MobileUser mobileUser)
      throws UsernameNotFoundException;
   ...
   */
  UserDetails loadUserByWxCodeAndTenantCode(String code, String tenantCode, WxUser wxUser)
      throws UsernameNotFoundException;
}
