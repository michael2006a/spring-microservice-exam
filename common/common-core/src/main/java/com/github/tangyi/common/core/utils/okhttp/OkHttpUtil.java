...
public class OkHttpUtil {
   ...
   * @date 2018/9/9 10:32
   */
  public String postForm(String url, Map<String, Object> header, Map<String, Object> data)
      throws Exception {
  ...
  public String put(String url, Map<String, Object> header, String file) throws Exception {
    RequestBody body = RequestBody
        .create(MediaType.parse("application/octet-stream"), new File(file));
   ...
   */
  public String putStream(String url, Map<String, Object> header, InputStream inputStream)
      throws Exception {
    RequestBody body = OkHttpRequestBodyUtil
        .create(MediaType.parse("application/octet-stream"), inputStream);
    Request.Builder builder = new Request.Builder().url(url).put(body);
    for (String key : header.keySet()) {
      builder.addHeader(key, header.get(key).toString());
    }
   ...
   * @date 2018/9/9 10:49
   */
  public String patch(String url, Map<String, Object> header, Map<String, Object> data)
      throws Exception {
