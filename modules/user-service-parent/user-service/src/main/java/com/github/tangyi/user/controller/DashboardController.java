...
public class DashboardController extends BaseController {
  ...
  public ResponseBean<DashboardDto> dashboard() {
    ...
    // 查询考试数量
    ResponseBean<Integer> examinationCountResponseBean = examinationService
        .findExaminationCount(tenantCode);
    ...
    // 查询参与人数
    ResponseBean<Integer> examUserCountResponseBean = examinationService
        .findExamUserCount(tenantCode);
