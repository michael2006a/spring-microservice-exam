...
public class AttachmentController extends BaseController {
  ...
  public PageInfo<Attachment> userList(
    ...
    return attachmentService
        .findPage(PageUtil.pageInfo(pageNum, pageSize, sort, order), attachment);
  }
  ...
  @Log("上传文件")
  public ResponseBean<Attachment> upload(
  ...
  public void download(@NotBlank Long id, HttpServletRequest request,
    ...
    try {
      ...
      response.setHeader(HttpHeaders.CONTENT_DISPOSITION,
          Servlets.getDownName(request, attachment.getAttachName()));
