 ...
 */
@Service
public class SubjectShortAnswerService extends
    CrudService<SubjectShortAnswerMapper, SubjectShortAnswer>
   ...
   */
  @Override
  @Cacheable(value = "subjectShortAnswer#"
      + CommonConstant.CACHE_EXPIRE, key = "#subjectShortAnswer.id")
   ...
   */
  @Override
  public SubjectDto getNextByCurrentIdAndType(Long examinationId, Long previousId,
      Integer nextType) {
    return null;
  }
  ...
  public PageInfo<SubjectDto> findSubjectPage(PageInfo pageInfo, SubjectDto subjectDto) {
    ...
    List<SubjectDto> subjectDtos = SubjectUtil
        .subjectShortAnswerToDto(subjectShortAnswerPageInfo.getList());
