...
public class CourseController extends BaseController {
  ...
  public PageInfo<Course> courseList(
  ...
  @PostMapping
  @PreAuthorize(
      "hasAuthority('exam:course:add') or hasAnyRole('" + SecurityConstant.ROLE_ADMIN + "')")
  ...
  @PutMapping
  @PreAuthorize(
      "hasAuthority('exam:course:edit') or hasAnyRole('" + SecurityConstant.ROLE_ADMIN + "')")
  ...
  @DeleteMapping("{id}")
  @PreAuthorize(
      "hasAuthority('exam:course:del') or hasAnyRole('" + SecurityConstant.ROLE_ADMIN + "')")
