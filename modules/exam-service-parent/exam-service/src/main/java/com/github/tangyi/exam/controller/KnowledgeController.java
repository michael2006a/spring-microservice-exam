...
public class KnowledgeController extends BaseController {
  ...
  public PageInfo<KnowledgeDto> knowledgeList(
    ...
    // 查询知识
    PageInfo<Knowledge> knowledgePageInfo = knowledgeService
        .findPage(PageUtil.pageInfo(pageNum, pageSize, sort, order), knowledge);
    ...
    // 根据附件ID查询附件
    ResponseBean<List<AttachmentVo>> returnT = userServiceClient
        .findAttachmentById(attachmentIdSet.toArray(new Long[0]));
