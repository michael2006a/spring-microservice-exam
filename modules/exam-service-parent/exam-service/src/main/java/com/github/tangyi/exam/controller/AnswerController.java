...
public class AnswerController extends BaseController {
  ...
  public PageInfo<Answer> answerList(
  ...
  public ResponseBean<SubjectDto> saveAndNext(@RequestBody AnswerDto answer,
    ...
    return new ResponseBean<>(
        answerService.saveAndNext(answer, nextType, nextSubjectId, nextSubjectType));
  }
  ...
  public PageInfo<AnswerDto> answerListInfo(
    ...
    PageInfo<Answer> answerPageInfo = answerService
        .findPage(PageUtil.pageInfo(pageNum, pageSize, sort, order), answer);
  ...
  public ResponseBean<AnswerDto> answerInfo(@PathVariable Long recordId,
    ...
    return new ResponseBean<>(
        answerService.answerInfo(recordId, currentSubjectId, nextSubjectType, nextType));
  }
}
